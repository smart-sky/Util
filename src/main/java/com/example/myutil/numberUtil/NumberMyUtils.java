 ...
 * @author xianfuhao
 */
public final class NumberMyUtils {
    /**
     * 单例
     */
    private NumberMyUtils() {
    }
    ...
    public static BigDecimal add(Number... numbers) {
        List<BigDecimal> list = createBigDecimalList(numbers);
    ...
    private static List<BigDecimal> createBigDecimalList(Number... numbers) {
        ...
        for (Number number : numbers) {
            list.add(createBigDecimal(number));
        }
        return list;
    }
    ...
    public static Number avg(Number... numbers) {
        Number total = add(numbers);
        int size = createBigDecimalList(numbers).size();
        return div(total, size);
    }
    ...
    public static Number abs(Number number) {
        BigDecimal bigDecimal = createBigDecimal(number);
    ...
    public static String format(Number number, String pattern) {
        BigDecimal decimal = createBigDecimal(number);
    ...
    public static boolean isNegativeNumber(String n) {
        return matches(n, "^-(([1-9]\\d*(\\.\\d+)?)|(0\\.\\d*[1-9]\\d*))$");
    }
    ...
    public static boolean notPositiveNumber(String n) {
        return matches(n, "^((-[1-9]\\d*(\\.\\d+)?)|(-0(\\.\\d+)?)|(0(\\.0+)?))$");
    }
